  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-stone-500 text-sm mt-1">{{ filteredProducts.length }} products</p>
      </div>
      <button
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          <thead class="bg-stone-50 text-stone-500 text-xs uppercase tracking-wider">
            <tr>
              <th class="text-left px-6 py-3 font-medium">Product</th>
              <th class="text-left px-6 py-3 font-medium">Category</th>
              <th class="text-left px-6 py-3 font-medium">Price</th>
              <th class="text-left px-6 py-3 font-medium">Stock</th>
              <th class="text-left px-6 py-3 font-medium">Color</th>
          ...
          <tbody class="divide-y divide-stone-100">
            ...
            >
              ...
              <td class="px-6 py-4 text-stone-600">{{ p.color || '-' }}</td>
              <td class="px-6 py-4 text-stone-600">{{ p.size || '-' }}</td>
              <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end gap-1">
                  <button
                    @click="router.push({ name: 'admin-products-edit', params: { id: p.id } })"
